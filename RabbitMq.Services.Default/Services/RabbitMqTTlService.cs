...
{
    public class RabbitMqTTlService : IRabbitMqService
    {
        private readonly IMessageBrokerService _messageBrokerService;
        private readonly AppConfigs _configs;

        public ServiceType ServiceType => ServiceType.TTL;


        public RabbitMqTTlService(IMessageBrokerService messageBrokerService, IOptions<AppConfigs> options)
        {
